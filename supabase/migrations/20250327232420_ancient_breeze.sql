/*
  # Update content schedules table and policies
...
CREATE TABLE IF NOT EXISTS content_schedules (
  ...
  content_id uuid REFERENCES content_items ON DELETE CASCADE NOT NULL,
...
DROP FUNCTION IF EXISTS process_scheduled_content() CASCADE;
